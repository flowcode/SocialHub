...
namespace Flowcode\SocialHubBundle\Tests\Controller;
...
class SocialNetworkControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/admin/socialnetwork/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'socialnetwork[name]' => 'Lorem ipsum dolor sit amet',
            'socialnetwork[description]' => 'Lorem ipsum dolor sit amet',
            'socialnetwork[clientId]' => 'Lorem ipsum dolor sit amet',
            'socialnetwork[clientSecret]' => 'Lorem ipsum dolor sit amet',
            'socialnetwork[loginEnabled]' => true,
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/socialnetwork/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'socialnetwork[name]' => 'Changed',
            'socialnetwork[description]' => 'Changed',
            'socialnetwork[clientId]' => 'Changed',
            'socialnetwork[clientSecret]' => 'Changed',
            'socialnetwork[loginEnabled]' => true,
            'socialnetwork[enabled]' => true,
